...
void cBonusBox :: Editor_State_Update( void )
{
	...
	// Force best item
	CEGUI::Combobox *combobox = static_cast<CEGUI::Combobox *>(CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChildRecursive( "editor_bonusbox_force_best_item" ));
	...
	// gold color
	combobox = static_cast<CEGUI::Combobox *>(CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChildRecursive( "editor_bonusbox_gold_color" ));
