...
public:
  cSave_Level_Object_Property(const std::string &new_name = "",
...
public:
  ...
  std::string Get_Description(unsigned int save_slot,
...
public:
  ...
  void Handle_Level_Spawned_Object(const CEGUI::String &element,
