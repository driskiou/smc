...
public:
  ...
  // enter
  std::string Enter(std::string default_text, std::string title_text,
                    bool auto_no_text = 1);
 ...
 */
void Draw_Static_Text(const std::string &text, const Color *color_text = &white,
                      const Color *color_bg = NULL, bool wait_for_input = 1);
