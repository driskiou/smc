...
void cParticle_Emitter :: Editor_Activate( void )
{
	...
	CEGUI::ToggleButton *checkbox = static_cast<CEGUI::ToggleButton *>(wmgr.createWindow(  "emitter_based_on_camera_pos" ));
	...
	*/
	...
	// start direction is added to the z rotation
	checkbox = static_cast<CEGUI::ToggleButton *>(wmgr.createWindow(  "emitter_start_rot_z_uses_direction" ));
