...
void cGoldpiece ::Set_Gold_Color(DefaultColor color) {
  ...
  if (m_type == TYPE_FALLING_GOLDPIECE) {
    ...
    // default is yellow
      ...
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/1_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/2_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/3_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/4_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/5_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/6_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/7_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/8_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/9_falling.png"));
      Add_Image(
          pVideo->Get_Surface("game/items/goldpiece/yellow/10_falling.png"));
...
void cGoldpiece ::Activate(void) {
  ...
  // animation
  cAnimation_Goldpiece *anim = new cAnimation_Goldpiece(
      m_sprite_manager, m_pos_x + (m_col_rect.m_w / 10),
      m_pos_y + (m_col_rect.m_h / 10));
...
cFGoldpiece ::cFGoldpiece(cSprite_Manager *sprite_manager,
                          ObjectDirection dir /* = DIR_NOTHING */)
    : cGoldpiece(sprite_manager) {
...
void cFGoldpiece ::Handle_Collision_Box(ObjectDirection cdirection,
                                        GL_rect *r2) {
  // if unsupported collision direction
  if (cdirection != DIR_DOWN && cdirection != DIR_LEFT &&
