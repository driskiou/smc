...
static const unsigned int smc_version =
    SMC_VERSION_NUM(SMC_VERSION_MAJOR, SMC_VERSION_MINOR, SMC_VERSION_PATCH);
...
enum GameModeType { MODE_TYPE_DEFAULT = 0, MODE_TYPE_LEVEL_CUSTOM = 1 };
