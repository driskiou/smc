...
public:
  ...
  inline void Clear_Hovered_Object(void) { Set_Hovered_Object(NULL); }
  ...
  // ## Snap Object
  /* set new_pos of the nearest object in the snap range using the given object
   * as the source returns 0 if no object found
   */
