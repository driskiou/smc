...
SMC_Spinner ::SMC_Spinner(const String &type, const String &name)
  ...
  // getEditbox()->subscribeEvent( Window::EventMouseWheel, Event::Subscriber(
  // &SMC_Spinner::Mouse_Wheel, this ) );
}
...
{
        const MouseEventArgs &mouse_event = static_cast<const MouseEventArgs&>(
event );
