...
/* Framerate class
 * speed factor is a float with that you multiply all your motions. For
 * instance, if the targetfps is 100, and the actual fps is 80, the speed factor
 * will be set to 100/80, or 1.25.
 */
class cFramerate {
public:
  cFramerate(void);
  ...
  typedef std::vector<cPerformance_Timer *> Performance_Timer_List;
