...
cEditor_CEGUI_Texture ::~cEditor_CEGUI_Texture(void) { cleanupOpenGLTexture(); }
...
cEditor ::~cEditor(void) { cEditor::Unload(); }
...
void cEditor ::Function_Exit(void) { pKeyboard->Key_Down(SDLK_F8); }
